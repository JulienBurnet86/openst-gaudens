    ...
    /*#__PURE__*/ React.createElement(
      ...
      /*#__PURE__*/ React.createElement(
        ...
        /*#__PURE__*/ React.createElement(
          "tr",
          null,
          /*#__PURE__*/ React.createElement("th", null, "Ranking"),
          /*#__PURE__*/ React.createElement("th", null, "Name"),
          /*#__PURE__*/ React.createElement("th", null, "Country")
        )
      ),
      /*#__PURE__*/ React.createElement(
        "tbody",
...
class EntryLists extends React.Component {
  ...
  componentDidMount() {
    fetch("/assets/js/entryList.json")
      ...
      .then((lists) => {
        console.log("0:", lists[0]);
        console.log("1:", lists[1]);
        this.setState({
...
ReactDOM.render(
  /*#__PURE__*/ React.createElement(EntryLists, null),
